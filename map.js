 ...
 /* if (search) {
  ...
  var weatherStationsTreePanel = new Ext.tree.TreePanel({
    ...
    ,tbar        : {items : new Ext.form.ComboBox({
      ...
      ,forceSelection : true
      ,triggerAction  : 'all'
      ,emptyText      : 'Search map for Station Name or Number.'
  ...
  if (byCatch) {
    ...
    sPanel =  {height : 400,border : false,region : 'south',id : 'byCatchPanel',bodyStyle : 'padding:5px 5px;overflow-x:hidden',layout : 'border',items : [
      new Ext.TabPanel({
        ...
        ,items          : [
          new Ext.FormPanel({
            ...
            ,layout  : 'anchor'
            ,items   : [
			{border : false,height : 110,layout : 'form',labelSeparator : '',labelWidth : 50,items : [
				...
				,new Ext.Slider({
                        ...
                        ,listeners      : {'change' : function(slider,val) {
                          var sto    = Ext.getCmp('byCatchMapsTypeComboBox').getStore();
                          var layers = sto.getAt(sto.findExact('id',Ext.getCmp('byCatchMapsTypeComboBox').getValue())).get('wmsLayers');
                          for (var i = 0; i < layers.length; i++) {
          ...
          ,new Ext.FormPanel({
            ...
            ,layout  : 'fit'
			,height  : 500
            ,items   : {cls : 'directionsText',html : '<div id="MapBackgroundContainer"><p class="settingTitle">Background</p><select id="MapBackground" multiple="multiple"><option value="CloudMade">CloudMade</option><option value="ESRI Ocean">ESRI Ocean</option><option value="Google Hybrid">Google Hybrid</option><option value="Google Satellite">Google Satellite</option><option value="Google Terrain">Google Terrain</option><option value="Nautical Charts">Nautical Charts</option><option value="OpenStreetMap">OpenStreetMap</option><option value="Shaded Relief (ETOPO1)">Shaded Relief (ETOPO1)</option><option value="Shaded Relief (GEBCO_08)">Shaded Relief (GEBCO_08)</option></select><br><div class="checkboxfilter"><input type="checkbox" id="bathymetry"/><span class="settingTitle">Bathymetry Contours(m)</span></div></div>',border : false}
          })
        ]
        ,listeners : {afterrender : function(p) {
          p.addListener('tabchange',function(p,tab) {
            Ext.getCmp('byCatchPanel').setHeight(tab.id == 'showByCatchPanel' ? 400 : 400);
          ...
          {border : false,region : 'center',id : 'queryFiltersPanel',bodyStyle : 'padding:5px 5px;overflow-x:hidden',layout : 'border',items : [
            new Ext.TabPanel({
              ...
              ,items          : [
                  ...
                  ,items   : [
                    {border : false,height : observationsPanelHeights.plain + (new RegExp(/^(Winds|Waves|WaterTemp|WaterLevel)$/).test(defaultObs) ? observationsPanelHeights.legendOffset : 0),items : [
                      ...
                      ,{
                        ...
                        ,items       : [
                          {
                             columnWidth  : 0.25 * (6 - availableObs.hits) / 2
                            ,border       : false
                            ,html         : '&nbsp;'
						  ...
						  ,new Ext.Button({
                             columnWidth  : 0.13
                            ,icon         : 'img/air_temp_transparent.png'
                            ,tooltip      : 'View Air temperature observations'
                            ,scale        : 'large'
                            ,iconAlign    : 'top'
                            ,toggleGroup  : 'weatherStationsOptionsDefaultObsGroup'
                            ,id           : 'weatherStationsOptionsWaterLevelButton2'
                            ,enableToggle : true
                            ,allowDepress : false
                            ,pressed      : defaultObs == 'airTemperature'
                            ,handler      : function() {
                              selectWeatherStationType('airTemperature');
                            }
                            ,hidden       : false
                          })
						  ...
						  ,new Ext.Button({
                             columnWidth  : 0.13
                            ,icon         : 'img/O2_transparent.png'
                            ,tooltip      : 'View Dissolved Oxygen observations'
                            ,scale        : 'large'
                            ,iconAlign    : 'top'
                            ,toggleGroup  : 'weatherStationsOptionsDefaultObsGroup'
                            ,id           : 'weatherStationsOptionsWaterLevelButton3'
                            ,enableToggle : true
                            ,allowDepress : false
                            ,pressed      : defaultObs == 'dissolvedOxygen'
                            ,handler      : function() {
                              selectWeatherStationType('dissolvedOxygen');
                            }
                            ,hidden       : false
                          })
                        ]
                      ...
                      ,{
                        ...
                        ,items       : [
                          ...
                          ,{
                             columnWidth  : 0.15
                            ,border       : false
                            ,html         : '<table id="weatherStationsOptionsWaterTempLabel" class="belowButtonsText' + (defaultObs == 'WaterTemp' ? 'Black' : 'Gray') + '" width="100%"><tr><td>Water<br>temp</td></tr></table>'
                          ...
                          ,{
                             columnWidth  : 0.15
                            ,border       : false
                            ,html         : '<table id="weatherStationsOptionsWaterLevelLabel" class="belowButtonsText' + (defaultObs == 'WaterLevel' ? 'Black' : 'Gray') + '" width="100%"><tr><td>Water<br>level</td></tr></table>'
                          ...
                          ,{
                             columnWidth  : 0.13
                            ,border       : false
                            ,html         : '<table id="weatherStationsOptionsAirTempLabel" class="belowButtonsText' + (defaultObs == 'AirTemp' ? 'Black' : 'Gray') + '" width="100%"><tr><td>Air<br>Temp</td></tr></table>'
                          }
						    ,{
                             columnWidth  : 0.01
                            ,border       : false
                          ...
                          ,{
                             columnWidth  : 0.19
                            ,border       : false
                            ,html         : '<table id="weatherStationsOptionsDissolvedOxygenLabel" class="belowButtonsText' + (defaultObs == 'DissolvedOxygen' ? 'Black' : 'Gray') + '" width="100%"><tr><td>Dissolved <br>oxygen</td></tr></table>'
                          }
                        ]
                      }
                      ,{
                ...
                ,new Ext.FormPanel({
                   id      : 'weatherPanel'
                  ,title   : 'Satellite/Radar'					// weatherTab + '<br>observations'
                  ,iconCls : weatherTab.toLowerCase() + 'Tab'
                  ,border  : false
                  ,cls     : 'formPanel'
                  ,layout  : 'anchor'
                  ,items   : [
                    {border : false,height : 108,layout : 'form',labelSeparator : '',labelWidth : 50,items : [
                ...
                ,new Ext.FormPanel({
                  ...
                  ,layout  : 'anchor'
                  ,items   : [
                    {border : false,height : 150,layout : 'form',labelSeparator : '',labelWidth : 50,items : [
				 ...
				 ,new Ext.FormPanel({
                  ...
                  ,items   : [
                    ...
                    ,{border : false,height : 29,layout : 'form',labelSeparator : '',labelWidth : 150,items : new Ext.form.RadioGroup({
...
/*
	...
	$('#queryFiltersPanel').css("height","100px");*/
  ...
  var fcWin = new Ext.Window({
    ...
    ,listeners : {
      show : function(p) {
        ...
        p.setPosition(0,mp.getHeight() - 120 + Number(banner.height));
...
function preparePopup(feature,regx,type,graph,graphTitle,fromSearch,pointsOnly) {
  ...
  if (t) {
    if (new Date().getTime() - t.getTime() > 3600000 * 24 * 7) {
      rows.unshift('<td colspan=2 align=center>' + new Date(t).format("mmm d, yyyy h:MM tt (Z)") + '</td>');
    }
    else {
      rows.unshift('<td colspan=2 align=center>' + dateToFriendlyString(t) + '</td>');
    }
  }
  else {
    rows.unshift('<td colspan=2 align=center>' + 'No reported observations.' + '</td>');
  }
        ...
        if (typeof val == 'string') {
          if (new RegExp(/\.(jpg|png)$/).test(val)) {
			...
			if (new RegExp(/direction/).test(v)) {
              ...
              cls = 'hazardData';
            }else if(v.indexOf("speed")>0){
			   cls += ' ' + getWindColor(val);
			}
        ...
        ,items   : new Ext.Button({
          ...
          ,handler   : function() {
            ...
            if (Ext.getCmp('byCatchTabPanel').getActiveTab().id != 'showByCatchPanel' || lyr.features.length <= 0) {
              Ext.Msg.alert('Report error','Please click on the map before attempting to create a report.');
              return;
            }
...
function getWindColor(speed){
	...
	if(speed < 0){
		color = 'blue';
	}else if(speed>7.5 && speed< 12.5){
		color= 'lightblue';
	}else if(speed>12.5 && speed< 17.50){
		color= 'babyblue';
	}else if(speed>17.5 && speed< 22.5){
		color= 'green';
	}else if(speed>22.5 && speed< 27.5){
		color= 'yellow';
	}else if(speed>27.5 && speed< 32.5){
		color= 'orange';
	}else if(speed>32.5 && speed< 37.5){
		color= 'redorange';
	}else if(speed>37.5){
		color= 'red';
	}
...
function printMap(data,pLonLat) {
  ...
  OpenLayers.Request.issue({
    ...
    ,callback : function(r) {
      ...
      //Ext.Msg.buttonText.ok = 'Close';
	  window.open("tmp/" + r.responseText); 
     // Ext.Msg.alert('Report complete','Click <a target=_blank href="tmp/' + r.responseText + '">here</a> for a printer-friendly page.');
     // Ext.Msg.buttonText.ok = 'OK';
    }
  });
}
...
/*
  new Ext.Button({
     text     : '<a href="#"> Sign In/ Register</a>'
  ...
  $("#sessionButton").append('<a href="javascript:printMap();" class="headerlinks" id="print">Print</a>');
 // $("#sessionButton").append('<a href="javascript:linkMap();return false;" class="headerlinks" id="link">Link</a>');
  $("#sessionButton").append('<a href="javascript:startChat()" class="headerlinks" id="comment">Comments</a>');  
  $("#sessionButton").append('<a href="javascript:showSignIn()" class="headerlinks" id="about">About</a>'); 
  $("#sessionButton").append('<a href="javascript:return false;" class="headerlinks" id="signLink">Login / Register</a>');
  $(".buttonContainer").append('<a href="#" class="headerlinksNav" id="station">Buoys</a>');
  $(".buttonContainer").append('<a href="#" class="headerlinksNav" id="radar">Radar</a>');
  $(".buttonContainer").append('<a href="#" class="headerlinksNav activeNav" id="model">Models</a>');
  $(".buttonContainer").append('<a href="#" class="headerlinksNav" id="weather">Weather</a>');
  $(".buttonContainer").append('<a href="#" class="headerlinksNav" id="report">Condition Report</a>');
    
  //add head button events 
  	$("#station").click(function() {
	  $(".headerlinksNav").removeClass("activeNav");
	  $(this).addClass("activeNav");
	  $("#mapTabPanel__observationsPanel a").children().click();
	});
	$("#radar").click(function() {
	  $(".headerlinksNav").removeClass("activeNav");
	  $(this).addClass("activeNav");
	  $("li#mapTabPanel__weatherPanel a").children().click();
	});
	$("#model").click(function() {
	  $(".headerlinksNav").removeClass("activeNav");
	  $(this).addClass("activeNav");
	  $("li#mapTabPanel__forecastsPanel a").children().click();
	});
	$("#weather").click(function() {
	  $(".headerlinksNav").removeClass("activeNav");
	  $(this).addClass("activeNav");
	  $("li#mapTabPanel__hazardsPanel a").children().click();
	  activeMode="weather";
	});
	...
	$('#byCatchTabPanel__showByCatchPanel a').children().click();
	 var lyr = map.getLayersByName('queryPt')[0];
		if (Ext.getCmp('byCatchTabPanel').getActiveTab().id != 'showByCatchPanel' || lyr.features.length <= 0) {
		  Ext.Msg.alert('Report error','Please click on the map before attempting to create a report.');
		  return;
	...
	$("#MapBackground").change(function() {
          var lyr = map.getLayersByName($('#MapBackground').val())[0];
          if (lyr.isBaseLayer) {
				map.setBaseLayer(lyr);
				lyr.redraw();
			}
	 });
	$('#bathymetry').change(function() {
			map.getLayersByName('Bathymetry contours')[0].setVisibility(this.checked);
	});
	//Ext.getCmp('mapTabPanel').getTabBar().setVisible(false);
	
	
	//default view to station
	//$("#station").click();
...
function showSignIn(){
	helpPage ? window.open(helpPage) : showSplash(true);
}
